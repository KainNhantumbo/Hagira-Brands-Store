	...
	return (
		<TermsAndConditionsContainer>
			...
			<article>
				<p>
					Ao acessar ao site{' '}
					<a href='hagira-brands.netlify.app'>Hagira Brands</a>, concorda em
				...
				<p>
					...
					materiais (informações ou software) no site Hagira Brands , apenas
				...
				<p>
					...
					dessas restrições e poderá ser rescindida por Hagira Brands a qualquer
				...
				<ol>
					<li>
						Os materiais no site da Hagira Brands são fornecidos 'como estão'.
						Hagira Brands não oferece garantias, expressas ou implícitas, e, por
					...
					<li>
						Além disso, o Hagira Brands não garante ou faz qualquer
				...
				<h2>4. Limitações</h2>
				<p>
					Em nenhum caso o Hagira Brands ou seus fornecedores serão responsáveis
					...
					uso ou da incapacidade de usar os materiais em Hagira Brands, mesmo
					que Hagira Brands ou um representante autorizado da Hagira Brands
				...
				<p>
					Os materiais exibidos no site da Hagira Brands podem incluir erros
					técnicos, tipográficos ou fotográficos. Hagira Brands não garante que
					qualquer material em seu site seja preciso, completo ou atual. Hagira
					Brands pode fazer alterações nos materiais contidos em seu site a
					qualquer momento, sem aviso prévio. No entanto, Hagira Brands não se
					compromete a atualizar os materiais.
				</p>
				<h2>6. Links</h2>
				<p>
					O Hagira Brands não analisou todos os sites vinculados ao seu site e
					não é responsável pelo conteúdo de nenhum site vinculado. A inclusão
					de qualquer link não implica endosso por Hagira Brands do site. O uso
					de qualquer site vinculado é por conta e risco do usuário.
				</p>
				<h3>Modificações</h3>
				<p>
					O Hagira Brands pode revisar estes termos de serviço do site a
				...
				<p>
					...
					leis do Hagira Brands e você se submete irrevogavelmente à jurisdição
