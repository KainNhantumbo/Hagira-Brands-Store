		...
		<TermsAndConditionsContainer>
			...
			<article>
				...
				<p>
					...
					<strong>Hagira Brands</strong> , apenas para visualização transitória
				...
				<ol>
					...
					<li>
						...
						contido no site <strong>Hagira Brands</strong>;{' '}
					</li>
					<li>
				...
				<p>
					Os materiais no site da <strong>Hagira Brands</strong> são fornecidos
					'como estão'.
				...
				<p>
					Os materiais exibidos no site da <strong>Hagira Brands</strong> podem
					...
					aviso prévio. No entanto, <strong>Hagira Brands</strong> não se
